    ...
    <div className="min-h-screen bg-stone-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
            ...
            <h1 className="font-serif text-4xl font-bold text-stone-900">Cancellation & Refund Policy</h1>
            <p className="text-stone-600 mt-2">At FlyingPopat, we want you to love your saree. Here is how our process works.</p>
        </div>

        <div className="bg-white rounded-xl shadow-sm border border-stone-100 p-8 space-y-10">
            
            {/* Cancellation Policy Section */}
            <section>
                <div className="flex items-center gap-3 mb-6 pb-2 border-b border-stone-100">
                    <XCircle className="text-red-500" size={28} />
                    <h2 className="text-2xl font-serif font-bold text-stone-900">Cancellation Policy</h2>
                </div>
                <div className="space-y-4 text-stone-700">
                    <p>
                        We understand that plans change. You can cancel your order under the following conditions:
                    </p>
                    <ul className="list-disc pl-5 space-y-2">
                        <li><strong>Before Shipment:</strong> You may cancel your order at any time before it has been shipped (Status: Pending or Processing). In this case, a <strong>full refund</strong> will be initiated to your original payment method.</li>
                        <li><strong>After Shipment:</strong> Once the order has been shipped, it cannot be cancelled. You will need to receive the package and initiate a return request.</li>
                    </ul>
                    <div className="bg-red-50 text-red-700 p-4 rounded-lg text-sm mt-4">
                        To cancel an order, go to <b>My Orders</b>, select the order, and click on the "Cancel Order" button.
                    </div>
                </div>
            </section>
            ...
            <section>
                 <div className="flex items-center gap-3 mb-6 pb-2 border-b border-stone-100">
                    <Clock className="text-royal-700" size={28} />
                    <h2 className="text-2xl font-serif font-bold text-stone-900">Return & Exchange Policy</h2>
                </div>
                
                {/* Key Policy */}
                <div className="bg-royal-50 border border-royal-100 rounded-lg p-6 mb-6">
                ...
                {/* How to Initiate */}
                <div className="mb-6">
                    <h3 className="text-lg font-bold text-stone-900 mb-4">How to Initiate a Return</h3>
             ...
             <section>
                <h2 className="text-xl font-bold text-stone-900 mb-3">Refund Process</h2>
